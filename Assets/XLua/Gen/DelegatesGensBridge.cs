...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp4(int p0, UnityEngine.RectTransform p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp6()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp7(string p0, string p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp9(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp10(UnityEngine.Vector3 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.MyStruct __Gen_Delegate_Imp11(XLuaTest.MyStruct p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.MyEnum __Gen_Delegate_Imp12(XLuaTest.MyEnum p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public decimal __Gen_Delegate_Imp13(decimal p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14(System.Array p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp16(int p0, string p1, out Tutorial.CSCallLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Action __Gen_Delegate_Imp17()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaTools.CallBack))
			{
			    return new LuaTools.CallBack(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(AntTimer.AntTimerCallBackDelegate))
			{
			    return new AntTimer.AntTimerCallBackDelegate(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(LuaBehaviour.LuaAction))
			{
			    return new LuaBehaviour.LuaAction(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(AntScroll.RenderDelegate))
			{
			    return new AntScroll.RenderDelegate(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(LuaBehaviour.LuaAction2))
			{
			    return new LuaBehaviour.LuaAction2(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(LuaBehaviour.ConfigNameList_GetRandomName))
			{
			    return new LuaBehaviour.ConfigNameList_GetRandomName(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(LuaBehaviour.ConfigYuanFen_GetData))
			{
			    return new LuaBehaviour.ConfigYuanFen_GetData(__Gen_Delegate_Imp7);
			}
			...
			{
			    return new XLuaTest.IntParam(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(XLuaTest.Vector3Param))
			{
			    return new XLuaTest.Vector3Param(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(XLuaTest.CustomValueTypeParam))
			{
			    return new XLuaTest.CustomValueTypeParam(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(XLuaTest.EnumParam))
			{
			    return new XLuaTest.EnumParam(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(XLuaTest.DecimalParam))
			{
			    return new XLuaTest.DecimalParam(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(XLuaTest.ArrayAccess))
			{
			    return new XLuaTest.ArrayAccess(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(System.Action<bool>))
			{
			    return new System.Action<bool>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(Tutorial.CSCallLua.FDelegate))
			{
			    return new Tutorial.CSCallLua.FDelegate(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(Tutorial.CSCallLua.GetE))
			{
			    return new Tutorial.CSCallLua.GetE(__Gen_Delegate_Imp17);
			}
