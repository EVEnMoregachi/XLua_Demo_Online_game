...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "SendMsg", _m_SendMsg_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "TriggerEnter_", _g_get_TriggerEnter_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "TriggerEnter_", _s_set_TriggerEnter_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SendMsg_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaBehaviour.SendMsg( _tag, _data );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_TriggerEnter_(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, LuaBehaviour.TriggerEnter_);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_ray(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    LuaBehaviour.ray = translator.GetDelegate<LuaBehaviour.LuaAction2>(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_TriggerEnter_(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    LuaBehaviour.TriggerEnter_ = translator.GetDelegate<LuaBehaviour.LuaAction>(L, 1);
