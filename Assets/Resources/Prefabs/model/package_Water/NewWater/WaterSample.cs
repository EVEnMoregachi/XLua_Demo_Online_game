...
public class WaterSample : MonoBehaviour
{
	...
	//public bool bRefractiveFog = true;
	//public FogMode iRefractiveFogMode = FogMode.Linear;
	//public Color iRefractiveFogColor = Color.white;
	//public float fRefractiveFogStart = 0.0f;
	//public float fRefractiveFogEnd = 0.0f;
	...
	public void OnWillRenderObject()
	{
		...
		if (mode >= WaterMode.Refractive)
		{
			...
			//no fog when refraction
            // �����������Ⱦ��ʼ,���泡�����������Ⱦ����
            //bool bOldFog = RenderSettings.fog;
            //Color iOldFogColor = RenderSettings.fogColor;
            //FogMode iOldFogMode = RenderSettings.fogMode;
            //float fOldFogStart = RenderSettings.fogStartDistance;
            //float fOldFogEnd = RenderSettings.fogEndDistance;
            //RenderSettings.fog = true;//bRefractiveFog;
            //RenderSettings.fogColor = iRefractiveFogColor;
            //RenderSettings.fogMode = iRefractiveFogMode;
            //RenderSettings.fogEndDistance = fRefractiveFogEnd;
            //RenderSettings.fogStartDistance = fRefractiveFogStart;
            // �����������Ⱦ��ʼ
			...
			// ��Ⱦ��ϣ���ԭԭʼ���ã��л���Ⱦ״̬
			//RenderSettings.fog = bOldFog;
			//RenderSettings.fogColor = iOldFogColor;
			//RenderSettings.fogMode = iOldFogMode;
			//RenderSettings.fogStartDistance = fOldFogStart;
			//RenderSettings.fogEndDistance = fOldFogEnd;
	...
	private void CreateWaterObjects( Camera currentCamera, out Camera reflectionCamera, out Camera refractionCamera )
	{
		...
		if( mode >= WaterMode.Refractive )
		{
			...
			if( !refractionCamera ) // catch both not-in-dictionary and in-dictionary-but-deleted-GO
			{
				...
				refractionCamera.gameObject.AddComponent<DisableFogForRefractive>();
				go.hideFlags = HideFlags.HideAndDontSave;
...
class DisableFogForRefractive : MonoBehaviour {
